      ...
      { problemInfo && 
        <>
          <Box className="flex mt-1">
            <span className="text-xs border inline-block px-1 mr-3 ml-1 my-auto rounded border-red-500 text-red-600 bg-red-200">{problemInfo.time_limit} sec</span>
            <span className="text-xs border inline-block px-1 my-auto rounded border-red-500 text-red-600 bg-red-200">{problemInfo.memory_limit} KB</span>
          </Box>
          <MathJaxContext config={mathJaxConfig}>
            <MathJax dynamic>
              <Box id="description" className="description" dangerouslySetInnerHTML={{ __html: problemInfo.html }}>
              </Box>
            </MathJax>
          </MathJaxContext>
        </>
